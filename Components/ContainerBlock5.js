...
function ContainerBlock5({line_no, hour, currentHour}){
    // console.log(line_no)
    // console.log(hour)
    const day = new Date()
    ...
    // const [blockdata, setBlockData] = useState(lines.map((e) => ({line : e, production: 0, target: 0, issue: ""})))
    ...
    const allTarget = [Number(target_1), Number(target_2), Number(target_3), Number(target_4), Number(target_5)]
    const allProduction = [Number(production_1), Number(production_2), Number(production_3), Number(production_4), Number(production_5)]
    const allIssues = [issue_1, issue_2, issue_3, issue_4, issue_5]
            ...
            <ScrollView style={styles.scrollview}>
                ...
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.dataContainer}>
                        ...
                        <View style={styles.datafield}>
                            <Text  
                            style={styles.text}>PRODUCTION</Text>
                            <TextInput 
                            multiline={true}
                            numberOfLines={1}
...
export default ContainerBlock5
