...
const styleWiseProcess = {
  ...
  Polo: [
    ...
    "Back neck tape attach",
    "Back neck tape close with label or loop",
    ...
    "Mark for slim fit for main label attach",
  ...
  "Sweat Shirt": [
    ...
    "Back neck tape attach",
    "Back neck tape close  with loop or label",
    "Sleeve pair & set",
    "Side seam  ",
  ...
  Jacket: [
    ...
    "Bottom rib servicing & Mark for bottom rib attach",
    "Bottom rib  attach",
    ...
    "Hood upper lower two part join ( 2 mC 1 OP)",
    "Hood upper & lower two part join topstitch ( 2 mC 1 OP)",
  ...
  Trouser: [
    "Body mark for pocket attach at front ",
    "Pocket 1st part attach at side",
    "Pocket topstitch",
    "Pocket 2nd part attach at side",
    "Flag label attach",
    "Back & front part set for side & tack for side seam",
    "Elastic edge cutter measure cut & iron",
    "Waist band edge servicing",
    "Hole at waist with mark",
    "Waist fold & tack for topstitch",
    "Bar tack at cross point ",
    "Bar tack at front pocket",
    "Drawcord middle tack",
    "Body & pocket mark for attach back & front",
    "Pocket rib attach at back",
    "Pocket 1st & 2nd part attach at back",
    "Pocket rib tack to body at back",
    "Pocket rib ol at back",
    "Pocket bag servicing at back",
    "Pocket binding mouth ol & mark for tack at waist front & back",
    "Pocket  false close",
    "Pocket rib attach at side pocket & mark",
    "Pocket rib tack to body at side",
    "Pocket inside stitch at side",
    "Pocket rib ol at side",
    "Pocket bag servicing at side",
    "Binding attach at pocket & role make",
    "Front rise join with fly & Back rise join",
    "Front ply false close both side",
    "Front ply J stitch",
    "Waist band join, fold & mark",
    "Mark & punch for hole",
    "Hole at wasit with fusing",
    "Care label make & attach",
    "Country label attach",
    "Drawcord insert",
    "Bar tack at waist",
    "Waist band & leg security tack",
    "Bartack at back pocket",
    "Waist loop & main label mark & attach",
    "Waist band topstitch",
    "Front pocket binding stitch open & end tack",
    "Pocket bag facing servicing",
    "Pocket bag facing tack to body",
    "Pocket bag mouth ol",
    "Pocket bag mouth tack to waist & side",
    "Pocket inside stitch at back",
    "Size label mark & attach",
    "Security label attach",
    "In seam",
    "Pocket 1st part attach ",
    "Pocket open",
    "Pocket 1st part edge ol",
    "Pocket rawstitch",
    "Pocket edge topstitch",
    "Pocket 2nd part attach ",
    "Pocket bag close",
    "Pocket bag turn & topstitch",
    "Pocket 2nd part tack with 1st part",
    "Pocket mouth close",
    "Front & back rise join topstitch",
    "Tack for side seam &Back & front part set for side",
    "Side seam",
    "Elastic join & mark",
    "Elastic false tack at waist",
    "Waist band servicing",
    "Waist band mark & body mark",
    "Waist band attach ",
    "loop mark & attach",
    "False stitch open",
    "Main label  mark & attach",
    "Leg rib join fold & mark ",
    "Leg rib inside tack",
    "Leg rib servicing",
    "Leg rib attach",
    "Leg rib topstitch",
    "Waist band topstitch ",
    "Waist knitting tape attach",
    "Waist knitting tape iron",
    "Back & front two part set",
    "Back & front rise join with mobilon tape",
    "Back & front rise topstitch",
    "Pocket panel edge ol",
    "Pocket panel false tack to body",
    "Pocket panel attach at pocket inside",
    "Pocket tack to body ",
    "Mark for pocket ol & close",
    "Pocket bag ol & close",
    "Side tab label mark & attach",
    "Upper & lower pocket tack for side",
    "Body servicing for waist & leg rib attach",
    "Leg rib join fold & mark & inside tack",
    "Leg rib tack to body & attach",
    "Leg rib servicing with body",
    "Waist band & elastic measure cut & dry & fusing set",
    "Waist band join fold & mark ",
    "Elastic tack to waist band",
    "Waist band trim",
    "Waist band tack to body & attach",
    "Waist band servicing with body",
    "Size label attach",
    "Draw cord measure cut & insert",
    "Bar tack at pocket & cross point",
    "Spot & sticker remove",
