...
import { Text, View, StyleSheet, TextInput, ScrollView, Button, Dimensions, Alert, KeyboardAvoidingView } from "react-native"
...
function ContainerBlock9({line_no, hour, currentHour}){
    // console.log(line_no)
    // console.log(hour)
    const day = new Date()
    ...
    const allTarget = [Number(target_1), Number(target_2), Number(target_3), Number(target_4), Number(target_5), Number(target_6), Number(target_7), Number(target_8), Number(target_9)]
    const allProduction = [Number(production_1), Number(production_2), Number(production_3), Number(production_4), Number(production_5), Number(production_6), Number(production_7), Number(production_8), Number(production_9)]
    const allIssues = [issue_1, issue_2, issue_3, issue_4, issue_5, issue_6, issue_7, issue_8, issue_9]
...
export default ContainerBlock9
